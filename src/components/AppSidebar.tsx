...
import { FileText, Home, Settings, PlusCircle, CheckSquare, Menu } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 py-6 px-3 space-y-1 overflow-y-auto scrollbar-hidden">
          ...
          <SidebarLink to="/criar-documento" icon={PlusCircle}>
            Criar Documento
          </SidebarLink>
          <SidebarLink to="/assinaturas" icon={CheckSquare}>
            Assinaturas
          </SidebarLink>
