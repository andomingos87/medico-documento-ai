...
import type { Appointment, UpdateAppointment } from '@/integrations/supabase/appointments';

interface Props {
  open: boolean;
  onOpenChange: (v: boolean) => void;
  appointment: Appointment | null;
  onSubmit: (id: string, values: UpdateAppointment) => Promise<void> | void;
}

export const EditAppointmentDialog: React.FC<Props> = ({ open, onOpenChange, appointment, onSubmit }) => {
  ...
  useEffect(() => {
    if (appointment) {
      ...
      setProcedureId(appointment.procedure_id || '');
