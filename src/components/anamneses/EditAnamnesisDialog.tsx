        ...
        {item && (
          <AnamnesisForm
            defaultValues={{
              ...
              continuousMedication: item.medicalHistory.continuousMedication,
              medicationAllergy: item.medicalHistory.medicationAllergy,
              previousProcedures: item.aestheticsHistory.previousProcedures,
              complications: item.aestheticsHistory.complications,
